...
class DonationFundstream(models.Model):
    ...
    line_ids = fields.One2many('donation.line', 'fundstream_id', string='Donations', copy=True , on_change='_compute_total_fund')
    source_ids = fields.One2many('donation.sourcefund', 'fundstream_id', string='Source of Fund', copy=True)
    ...
    sub_theme = fields.Selection([
        (1, 'Development'),
        (2, 'Humaniterian'),
        (3, 'Full Spectrum')], string='Context', default=1, index=True, track_visibility='onchange')
