...
class DonationDonation(models.Model):
    ...
    donation_collector = fields.Many2one('hr.employee', string='Collector', track_visibility='onchange')
    ...
    move_analytic_id = fields.Many2one(
        'account.analytic.line', string='Account Analytic', readonly=True, copy=False)
        ...
        for donation in self:
            ...
            if donation.amount_total:
                ...
                if move_vals:
                    ...
                    self.env.cr.execute("SELECT id FROM account_move_line where move_id = '%s' and analytic_account_id ='%d'" %(move.id,analytic))
...
class DonationLine(models.Model):
    ...
    #campaign_id = fields.Many2one(
    analytic_account2 = fields.Many2one('account.analytic.account',related='donation_id.campaign_id.analytic_account_id', string='Analytic Account', readonly=True, store=True)
    ...
    donation_method = fields.Many2one(related='product_id.donation_method', readonly=True, store=True,string = 'Method')
