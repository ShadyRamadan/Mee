...
class DonationPlace(models.Model):
    _name = 'donation.box'
    _description = 'Code attributed for a Donation boxes'
    _order = 'code'
    _rec_name = 'code'
    ...
    _sql_constraints = [
            ('display_name_uniq', 'UNIQUE (name)',  'This Box already exists'),
            ('code_uniq', 'UNIQUE (code)',  'This Box Code already exists')
        ]