        ...
        if len(self.attendancedata) > 0:
            ...
            while len(attendancedata) > 40:
                ...
                if space == '':
	                ...
	                action='action'
                #print "%s, %s, %s" % (uid, action , decode_time( int( reverseHex( timestamp.encode('hex') ), 16 ) ) )

                attendance.append( ( uid, action, decode_time( int( reverseHex( timestamp.encode('hex') ), 16 ) ) ) )
