...
class PurchaseRequestMakeCustody(models.TransientModel):
    _name = "purchase.request.make.custody"
    _description = "Purchase Request Make Custody"
...
class PurchaseRequestLineMakePurchaseOrderItem(models.TransientModel):
    ...
    product_price = fields.Float(string='Unit Price', required=True)
