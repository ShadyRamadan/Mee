...
class AdvanceSettlementLine(models.Model):
    ...
    invoice_partner = fields.Many2one('res.partner',related='invoice_id.partner_id', string="Vendor", store=True)
    invoice_date = fields.Date(related='invoice_id.date_invoice', string="Invoice Date", store=True)
    invoice_amount = fields.Monetary(string="Invoice Total", related='invoice_id.amount_total', store=True)
