...
class gov(models.Model):
    ...
    english_name = fields.Char('Governorate Name', required=False)
    ...
    _sql_constraints = [
            ...
            ('english_name_uniq', 'UNIQUE (english_name)',  'This Governorate English Name already exists'),
...
class city(models.Model):
    ...
    english_name = fields.Char('City Name', required=False)
    ...
    _sql_constraints = [
            ...
            ('english_name_uniq', 'UNIQUE (english_name)',  'This City English Name already exists'),
...
class village(models.Model):
    ...
    english_name = fields.Char('Village Name', required=False)
    #state_id = fields.Many2one('res.country.state', 'State', required=True)
