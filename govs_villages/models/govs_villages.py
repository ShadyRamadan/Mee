...
class gov(models.Model):
    ...
    gov_en_id = fields.Many2one('govs.villages.enggov',string='Governorate Name', required=False)
...
class city(models.Model):
    ...
    city_en_id = fields.Many2one('govs.villages.engcity',string='City Name', required=False)
...
class village(models.Model):
    ...
    village_en_id = fields.Many2one('govs.villages.engvillage',string='Village Name', required=False)
    ...
    class eng_gov(models.Model):
        ...
        name = fields.Char('Governorate Name', required=True)
