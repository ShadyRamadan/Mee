...
#]
    ...
    contract_agreement = fields.Binary('العقد 1', attachment=True)
    ...
    contract_agreement2 = fields.Binary('العقد 2', attachment=True)
    ...
    contract_agreement_all = fields.Binary('العقد 1', attachment=True)
    filename17_all = fields.Char('file name', readonly = True,store = False,compute ='legacy_doc1_getFilename')
    
    contract_agreement2_all = fields.Binary('العقد 2', attachment=True)
