   ...
   # @api.one
    ...
    def change_colore_on_kanban(self):   
        for record in self:
            ...
            record.color = color
    @api.one
    @api.depends('state','national_paper','national_paper2','social_status','social_status2','criminal_case','insurance_husband','eductional_qualification','holding_husband','holding_father','holding_wife')
    def change_progress(self):
        for rec2 in self:
            if rec2.state == 'papers' or rec2.state == 'execution' or rec2.state == 'follow': 
               if rec2.national_paper == False or rec2.national_paper2 == False or rec2.social_status == False  or rec2.social_status2 == False or rec2.criminal_case == False or rec2.insurance_husband == False or rec2.eductional_qualification == False or rec2.holding_husband == False or rec2.holding_father == False or rec2.holding_wife == False:
                    rec2.progress = 0
               else:
                    rec2.progress = 100
            else:
