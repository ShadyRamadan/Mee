...
_ROLES = [
    ...
    (3, 'مسئول إعتماد'),
    (2, 'مسئول توثيق'),
    (1, 'مسئول متابعة إقتصادية'),
    (2, 'مسئول تدريب'),
    (1, 'IT مسئول'),
    (2, 'مسئول مركز'),
    (1, 'مسئول مشروع في أحد المراكز'),
    (2, 'متطوع في فريق اﻷبحاث'),
    (1, 'متطوع في فريق الإعتماد'),
    (2, 'متطوع في فريق التوثيق'),
    (1, 'متطوع في فريق المتابعة الإقتصادية'),
    (2, 'متطوع في فريق التدريب'),
    (1, 'IT متطوع في فريق')
]
