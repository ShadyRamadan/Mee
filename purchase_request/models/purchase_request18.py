    ...
    def change_done_stage(self):
        for rec in self:
            if rec.price_alltotal <= 500:
                if rec.x_stage == 1 and rec.ontime_stage > 1:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==2 and rec.ontime_stage > 2:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==3 and rec.ontime_stage > 4:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==4 and rec.ontime_stage > 4:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==5 and rec.ontime_stage > 4:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==6 and rec.ontime_stage > 4:
                    dd = "late"
                    rec.done1 = dd
                ...
                if rec.x_stage == 1 and rec.ontime_stage > 1:
                    ...
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==3 and rec.ontime_stage > 5:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==4 and rec.ontime_stage > 5:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==5 and rec.ontime_stage > 5:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==6 and rec.ontime_stage > 5:
                    dd = "late"
                    rec.done1 = dd
                ...
                if rec.x_stage == 1 and rec.ontime_stage > 1:
                    ...
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==3 and rec.ontime_stage > 7:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==4 and rec.ontime_stage > 7:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==5 and rec.ontime_stage > 7:
                    dd = "late"
                    rec.done1 = dd
                elif rec.x_stage ==6 and rec.ontime_stage > 7:
                    dd = "late"
                    rec.done1 = dd
                elif (rec.x_stage ==7 or rec.x_stage ==8 or rec.x_stage ==9 or rec.x_stage ==10)  and rec.ontime_stage > 15:
                    dd = "late"
                    rec.done1 = dd
                elif (rec.x_stage ==11 or rec.x_stage ==12 or rec.x_stage ==13)  and rec.ontime_stage > 12:
                    dd = "late"
                    rec.done1 = dd
